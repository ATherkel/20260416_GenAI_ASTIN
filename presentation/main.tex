...
\begin{frame}{\insertsection}
  \slidetarget
  \begin{itemize}
    \item Læring er en aktiv, konstruktiv proces — ikke passiv forbrug
    \item Man lærer ikke at tegne ved at tegne efter
    \item GPS
  \end{itemize}

  \vfill
  {\small\textcolor{dimmed}{%
    Vigtigt: brug det som et supplement til aktiv læring, ikke som en genvej.}}
\end{frame}
